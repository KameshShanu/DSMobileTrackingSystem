                    ...
                    <div class="card p-30">
                        <div class="media">
                            <div class="media-left meida media-middle">
                                <span><i class="fa fa-mobile f-s-40 color-primary"></i></span>
                            </div>
                            <div class="media-body media-text-right">
                                <h2><?php
                                    $q=mysql_query("SELECT * FROM device where status=1");
                                    $co=0;
                ...
                <div class="col-md-3">
                    <div class="card p-30">
                        <div class="media">
                            ...
                            <div class="media-body media-text-right">
                                <h2><?php
                                        $q=mysql_query("SELECT * FROM user where status=1");
                                        $co=0;
                                        while($row = mysql_fetch_array($q))
                                            $co++;
                                        echo $co;
